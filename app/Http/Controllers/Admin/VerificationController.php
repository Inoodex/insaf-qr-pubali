...
class VerificationController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            'statement_period_from'  => 'nullable|date',
            'statement_period_to'    => 'nullable|date|after_or_equal:statement_period_from',
            'statement_generated_at' => 'nullable|date',
            'report_generation_date' => 'nullable|date',
            'bank_name'              => 'nullable|string|max:255',
            'branch_name'            => 'nullable|string|max:255',
            'currency'               => 'nullable|string|max:10',
            'equivalent_balance'     => 'nullable|string|max:50',
        ], [
            'account_no.regex'                       => 'The Account Number must contain only numbers (digits 0-9).',
            'account_no.unique'                      => 'An account verification with this Account Number already exists.',
            'certificate_balance.string'             => 'The Certificate Balance must be a valid amount.',
            ...
            'statement_period_to.after_or_equal'     => 'The statement period end date must be on or after the start date.',
        ]);
